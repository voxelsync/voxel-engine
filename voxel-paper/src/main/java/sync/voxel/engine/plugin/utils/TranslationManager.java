...
public class TranslationManager {
    ...
    private static @NotNull Map<String, String> loadLocalOverrides(String locale) {
        ...
        try (Reader reader = new InputStreamReader(new FileInputStream(file), StandardCharsets.UTF_8)) {
            ...
            Bukkit.getLogger().warning("Could not load local translation file for " + locale + ": " + e.getMessage());
        }
        return result;
    }
    ...
    private static @Nullable Map<String, String> downloadOnlineTranslation(String locale) {
        try {
            ...
            Bukkit.getLogger().warning("Failed to download online translation for " + locale + ": " + e.getMessage());
        }
        return null;
    }
