...
/**
 * Represents a material (item/block) in the VoxelSync system.
 * <p>
 ...
 * </p>
 *
 * @see sync.voxel.api.item.VoRarity
...
public interface VoMaterial {
    ...
    /**
     * Checks if this material is an item.
     *
     * @return true if this material is an item, false otherwise
     */
    boolean isItem();
